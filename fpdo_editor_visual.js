...
(function () {
  ...
  function close() { var x = document.getElementById('p96Fundo'); if (x) x.remove(); editor = null; }
  function render() {
    ...
    var q = function (id) { var e = document.getElementById(id); if (e) e.value = s[id] == null ? '' : s[id]; };
    q('p96Titulo'); q('p96Url'); q('p96Texto'); q('p96Cor'); var layoutEl = document.getElementById('p96Layout'); if (layoutEl) layoutEl.value = s.layout || 'imagem-direita';
